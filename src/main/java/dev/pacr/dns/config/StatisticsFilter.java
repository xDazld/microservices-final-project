 ...
 * <p>
 * This filter intercepts all REST requests and responses to measure: - Response time - HTTP status
 * codes - Request/response sizes
 * <p>
 * Statistics are recorded per endpoint and can be accessed via the admin endpoint.
 */
@Provider
